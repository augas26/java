...
public class SightingDaoDB implements SightingDao {
    ...
    @Override
    public List<Sighting> getLastSighting() {
        final String SELECT_TOP_TEN_Sighting = "SELECT * FROM Sighting ORDER BY sighId DESC LIMIT 10";
        List<Sighting> sights = jdbc.query(SELECT_TOP_TEN_Sighting, new SightingMapper());
        associateHeroSightAndLocation(sights);
        return sights;
